...
export default function MasterclassLanding() {
  ...
  useEffect(() => {
    AOS.init({
      ...
      once: true, // Trigger animations only once as you scroll down
    });
  }, []);
  ...
  return (
    <div style={{ backgroundColor: '#0D0C0D' }} className="min-h-screen text-white">
      {/* Hero Section */}
      <div style={{ background: 'linear-gradient(135deg, #171617 0%, #0D0C0D 50%, #171617 100%)' }}>
        <div className="container mx-auto px-4 py-20">
          <div className="max-w-3xl mx-auto text-center" data-aos="fade-up">
            ...
            <p className="text-xl md:text-2xl mb-2" data-aos="fade-up" data-aos-delay="200">
              TÂCHES PRESENTS:
            </p>
            <h1 className="font-poppins text-4xl md:text-6xl font-bold mt-0 mb-6" data-aos="fade-up" data-aos-delay="300">
              A.I. SAMPLING MASTERCLASS
            </h1>
            <p className="text-xl md:text-2xl mb-8" data-aos="fade-up" data-aos-delay="400">
              A Revolutionary Masterclass in AI-Assisted Music Production
            </p>
            <p className="text-lg mb-8 max-w-2xl mx-auto text-gray-300" data-aos="fade-up" data-aos-delay="500">
            ...
            <div className="flex items-center justify-center gap-4 mb-8" data-aos="fade-up" data-aos-delay="600">
              <Clock className="w-5 h-5" style={{ color: '#E6AC55' }} />
              <span className="text-lg">Thurs 7th November | 11AM-1PM EST </span>
            </div>
            <a href="https://www.tachesteaches.courses/offers/Diu98a77" target="_blank" rel="noopener noreferrer" data-aos="fade-up" data-aos-delay="700">
              <Button 
                size="lg" 
                style={{ backgroundColor: '#E6AC55', color: '#0D0C0D' }}
      ...
      <div style={{ backgroundColor: '#171617' }} className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center space-y-8">
            <h2 className="font-poppins text-3xl md:text-4xl font-bold" data-aos="fade-up">
            ...
            <ul className="text-lg text-gray-300 text-left space-y-4" data-aos="fade-up" data-aos-delay="200">
            ...
            <p className="text-xl text-gray-300" data-aos="fade-up" data-aos-delay="300">
              Sampling is powerful, but it’s limited by two things:
            </p>
            <ol className="list-decimal text-left text-lg text-gray-300 space-y-4 ml-6" data-aos="fade-up" data-aos-delay="400">
              <li>You can only sample what already exists.</li>
              <li>You are limited by the luck of what you can find.</li>
            </ol>
            <p className="text-xl text-gray-300" data-aos="fade-up" data-aos-delay="500">
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="max-w-3xl mx-auto mb-16">
          <div className="space-y-8 text-lg text-white">
            <Card style={{ background: 'linear-gradient(135deg, #171617 0%, #1A1919 100%)', borderColor: 'rgba(230,172,85,0.2)' }} className="p-8" data-aos="fade-up">
        ...
        {/* Who It's For */}
        <Card style={{ background: 'linear-gradient(135deg, #171617 0%, #1A1919 100%)', borderColor: 'rgba(230,172,85,0.2)' }} className="max-w-3xl mx-auto p-8 mb-16" data-aos="fade-up">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto mb-16">
          {features.map((feature, index) => (
            <Card 
              key={index} 
              style={{ background: 'linear-gradient(135deg, #171617 0%, #1A1919 100%)', borderColor: 'rgba(230,172,85,0.2)' }}
        ...
        {/* Final CTA */}
        <Card style={{ background: 'linear-gradient(135deg, #171617 0%, #1A1919 100%)', borderColor: 'rgba(230,172,85,0.2)' }} className="text-center max-w-2xl mx-auto p-16" data-aos="fade-up">
        ...
        {/* Teacher Bio Section */}
        <div className="teacher-bio-section flex flex-col justify-center items-center text-center pt-16 pb-8" data-aos="fade-up">
